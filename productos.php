...
#Realiza una Solicitud al Token y al Id de los articulos.
  ...
  $sql = $con->prepare("SELECT id, nombre, descripcion, id_Categoria FROM productos WHERE $id=id_Categoria");
  $sql->execute();
...
<html lang="en" class="h-100">
  ...
  <body class="text-center " oncontextmenu="return false;">
    ...
    <a href="https://api.whatsapp.com/send?phone=04129485518" class="btn-wsp" target="_blank">
                ...
                <div class="col">
                  <div class="card shadow-sm" style="background-color:gray; width:100% ;height: 380px; ">
                      ...
                      <div class="d-block justify-content-between align-items-center">
                          <div class="card_body">
                              <a href="Detalles.php?id_Categoria=<?php echo $row[('id_Categoria')];?>&token=<?php echo hash_hmac('sha512', $row['id_Categoria'], KEY_TOKEN);?>" class="btn btn-lg btn-dark fw-medium border-dark bg-dark">Ir Ahora</a>
                          </div>
                      </div>
                      </div>
                  </div>
